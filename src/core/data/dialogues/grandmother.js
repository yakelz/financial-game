const dialogues = {
	...
	4: {
		id: 4,
		audio: './Audio/Voices/Grandmother/res3-1.mp3',
		name: 'Валентина Павловна',
	...
	5: {
		id: 5,
		audio: './Audio/Voices/Grandmother/res4-1.mp3',
		name: 'Валентина Павловна',
		speech: 'Да, конечно',
		choices: [
			{
	...
	6: {
		id: 6,
		audio: './Audio/Voices/Grandmother/res5-2.mp3',
		name: 'Валентина Павловна',
		speech: 'Да',
		choices: [
			{
			...
			},
			{
				...
				audio: './Audio/Voices/Grandmother/9-1.mp3',
				responseId: 9,
			},
		],
	},
	7: {
		id: 7,
		audio: './Audio/Voices/Grandmother/res5-1.mp3',
		name: 'Валентина Павловна',
	...
	8: {
		id: 8,
		audio: './Audio/Voices/Grandmother/res6-1.mp3',
		name: 'Валентина Павловна',
		...
		choices: [
			{
				...
				audio: './Audio/Voices/Grandmother/10-1.mp3',
				responseId: 11,
			},
		],
	},
	9: {
		id: 9,
		audio: './Audio/Voices/Grandmother/res6-2.mp3',
		name: 'Валентина Павловна',
		speech: '19.02.2024 в 16:12',
		choices: [
			{
				id: 1,
				text: 'Назовите номер телефона, с которого поступил звонок',
	...
	14: {
		...
		choices: [
			{
				id: 1,
				text: 'Спасибо Валентина. Вы мне очень помогли. Я начну расследование. Если будут новые вопросы к Вам, получите в письменном виде вызов в отделение полиции.',
				audio: './Audio/Voices/Grandmother/6-1.mp3',
				responseId: 15,
			},
		],
