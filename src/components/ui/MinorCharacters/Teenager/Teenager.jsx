...
import TeenagerImg from '@assets/UI/MinorCharacters/Teenager/teenager.svg?react';
import styles from './Teenager.module.css';
...
function Teenager({ svgRef }) {
	...
	return (
		<>
			<img ref={mouthRef} src={currentMouth} alt='Рот персонажа' className={styles.mouth} />
			<TeenagerImg ref={imgRef} className={styles.teenager} />
		</>
	);
}
